...
class HumidityControlCapabilities:
    ...
    humidification: HumidityCapabilities | None
    """Humidification capability settings. Only populated if supported."""
    dehumidification: HumidityCapabilities | None
    """De-humidification capability settings. Only populated if supported."""
    ...
    def __init__(self, data: dict) -> None:
        ...
        self.humidification = HumidityCapabilities(sub_data) if sub_data else None
        sub_data = data.get("dehumidification")
        self.dehumidification = HumidityCapabilities(sub_data) if sub_data else None
