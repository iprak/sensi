...
@dataclass
class SetTemperatureSuccessInfo:
...
@dataclass
class SetOperatingModeSuccessInfo:
...
class SetCirculatingFanEventValue:
    """Thermostat information sent for set_fan_mode event."""
...
@dataclass
class SetCirculatingFanEventInfo:
    """Thermostat information sent for set_fan_mode event."""
...
@dataclass
class SetFanModeEventSuccessInfo:
    """Representation of set_operating_mode success response."""
